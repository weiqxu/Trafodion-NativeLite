# LocalLite M23 后续阶段：publication group commit 解串行化
...
- group commit 窗口仍由 `TRAF_LOCAL_LITE_GROUP_COMMIT_WINDOW_US` 控制，默认
  0，不使用异步提交作为正式结果。
...
- `/tmp/traf-local-lite-m23-phase6-report/workload-report.json`
- `/tmp/traf-local-lite-m23-phase6-500-report/workload-report.json`
