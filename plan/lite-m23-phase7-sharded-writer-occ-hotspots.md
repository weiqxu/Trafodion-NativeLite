...
- 默认 8 个 durable-writer shard，可由 `TRAF_LITE_DURABLE_SHARDS` 调低
...
验证命令使用 `LITE_BUILD_TYPE=release`、10 warehouse/32 terminal、64
workers、同步提交和 `TRAF_LITE_GROUP_COMMIT_WINDOW_US=0`，源码 revision
