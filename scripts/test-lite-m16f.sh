...
artifact_dir=${TPCC_ARTIFACT_DIR:-/tmp/traf-lite-m16-report}
performance_script="$repo_root/scripts/test-lite-tpcc-performance.sh"
...
echo "Lite M16F Release Stock-Level qualification passed"
