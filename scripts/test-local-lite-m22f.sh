...
performance="$repo_root/scripts/test-local-lite-tpcc-performance.sh"
...
artifact_dir=${M22_REPORT_DIR:-/tmp/traf-local-lite-m22-full-report}
env TRAF_LOCAL_LITE_SYNC_COMMIT=1 \
...
echo "LocalLite M22F full-cardinality qualification passed"
