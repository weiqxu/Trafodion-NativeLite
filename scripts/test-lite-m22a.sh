...
store_source="$repo_root/core/sql/litestore/LiteRocksDBStore.cpp"
plan="$repo_root/plan/lite-m22-concurrency-qualification.md"
...
echo "Lite M22A stage and conflict telemetry contract passed"
