...
class ExpHbaseInterface_Lite : public ExpHbaseInterface
{
public:
  ExpHbaseInterface_Lite(CollHeap *heap, const char *server, const char *zkPort)
...
ExpHbaseInterface *ExpHbaseInterface::newInstance(CollHeap *heap,
                                                  ...
                                                  const char *zkPort)
{
  return new (heap) ExpHbaseInterface_Lite(heap, server, zkPort);
}
