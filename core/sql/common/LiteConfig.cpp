...
// In lite mode the IPC/messaging layer is never initialized, so
...
// In lite mode there is no monitor process.  These functions are
...
int LiteConfig_init()
{
    ...
    // Keep executor spill/scratch files inside the isolated lite store
